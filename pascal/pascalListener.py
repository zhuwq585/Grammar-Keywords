...
class pascalListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by pascalParser#re_type.
    def enterRe_type(self, ctx:pascalParser.Re_typeContext):
        pass

    # Exit a parse tree produced by pascalParser#re_type.
    def exitRe_type(self, ctx:pascalParser.Re_typeContext):
        pass
    ...
    # Enter a parse tree produced by pascalParser#re_set.
    def enterRe_set(self, ctx:pascalParser.Re_setContext):
        pass

    # Exit a parse tree produced by pascalParser#re_set.
    def exitRe_set(self, ctx:pascalParser.Re_setContext):
        pass
