// Generated from /home/syu/workspace/MCCD/Project/parsers/ECMAScript/ECMAScript.g4 by ANTLR 4.8
...
public class ECMAScriptParser extends Parser {
	...
	public final SourceElementContext sourceElement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(120);
				if (!(self._input.LA(1) != ECMAScriptParser.Function)) throw new FailedPredicateException(this, "self._input.LA(1) != ECMAScriptParser.Function");
				setState(121);
				statement();
				}
				break;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				{
				setState(128);
				if (!(self._input.LA(1) != ECMAScriptParser.OpenBrace)) throw new FailedPredicateException(this, "self._input.LA(1) != ECMAScriptParser.OpenBrace");
				setState(129);
				expressionStatement();
				}
				break;
	...
	public final ContinueStatementContext continueStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(251);
				if (!(not self.here(ECMAScriptParser.LineTerminator))) throw new FailedPredicateException(this, "not self.here(ECMAScriptParser.LineTerminator)");
				setState(252);
				match(Identifier);
				}
				break;
	...
	public final GetterContext getter() throws RecognitionException {
		...
		try {
			...
			{
			setState(608);
			if (!(self._input.LT(1).text == "get")) throw new FailedPredicateException(this, "self._input.LT(1).text == \"get\"");
			setState(609);
			match(Identifier);
			setState(610);
			propertyName();
	...
	public final SetterContext setter() throws RecognitionException {
		...
		try {
			...
			{
			setState(612);
			if (!(self._input.LT(1).text == "set")) throw new FailedPredicateException(this, "self._input.LT(1).text == \"set\"");
			setState(613);
			match(Identifier);
			setState(614);
			propertyName();
	...
	public final EosContext eos() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				{
				setState(619);
				if (!(self._input.LT(1).type == ECMAScriptParser.CloseBrace)) throw new FailedPredicateException(this, "self._input.LT(1).type == ECMAScriptParser.CloseBrace");
				}
				break;
			}
		}
