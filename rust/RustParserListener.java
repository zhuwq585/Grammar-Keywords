...
public interface RustParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RustParser#matchArmPatterns}.
	 * @param ctx the parse tree
	 */
	void enterMatchArmPatterns(RustParser.MatchArmPatternsContext ctx);
	/**
	 * Exit a parse tree produced by {@link RustParser#matchArmPatterns}.
	 * @param ctx the parse tree
	 */
	void exitMatchArmPatterns(RustParser.MatchArmPatternsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link RustParser#rangePattern}.
	 * @param ctx the parse tree
	 */
	void enterRangePattern(RustParser.RangePatternContext ctx);
	/**
	 * Exit a parse tree produced by {@link RustParser#rangePattern}.
	 * @param ctx the parse tree
	 */
	void exitRangePattern(RustParser.RangePatternContext ctx);
	/**
	 * Enter a parse tree produced by {@link RustParser#obsoleteRangePattern}.
	 * @param ctx the parse tree
	 */
	void enterObsoleteRangePattern(RustParser.ObsoleteRangePatternContext ctx);
	/**
	 * Exit a parse tree produced by {@link RustParser#obsoleteRangePattern}.
	 * @param ctx the parse tree
	 */
