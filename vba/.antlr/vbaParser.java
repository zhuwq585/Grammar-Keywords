...
public class vbaParser extends Parser {
	...
	public static final int
		...
		RULE_letterrange = 136, RULE_lineLabel = 137, RULE_literal = 138, RULE_re_type = 139, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"re_type", "typeHint", "visibility", "ambiguousKeyword", "remComment", 
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		public TerminalNode NULL_() { return getToken(vbaParser.NULL_, 0); }
	...
	public final Re_typeContext re_type() throws RecognitionException {
		...
		enterRule(_localctx, 278, RULE_re_type);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
